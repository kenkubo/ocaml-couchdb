...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8f889192b0e4bf873846791f693ee39b) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("deriving-yojson", None);
                           FindlibPackage ("deriving-yojson.syntax", None);
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for CouchDB";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "couchdb";
                           FindlibPackage ("oUnit", None);
                           InternalLibrary "test_type"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\208\127G$<d\185#c\020u\147\172@\017e";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
